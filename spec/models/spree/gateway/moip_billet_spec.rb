...
describe Spree::Gateway::MoipBillet, moip: { type: :billet }, vcr: { cassette_name: 'models/moip_billet' } do
  it_behaves_like 'moip gateway'

  describe '#authorize', vcr: { cassette_name: 'models/moip_billet/authorize' } do
