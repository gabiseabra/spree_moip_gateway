FactoryGirl.define do
  factory :moip_base_gateway, class: Spree::Gateway::MoipBase do
    name 'Moip Gateway'
    ...
    factory :moip_credit_gateway, class: Spree::Gateway::MoipCredit

    factory :moip_billet_gateway, class: Spree::Gateway::MoipBillet do
